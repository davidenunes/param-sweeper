...
/**
 * <p>
 * Utility class with static methods to create different {@link ParameterSweep}
 * objects and {@link CombinedParameterSweep} objects.
 * </p>
 * 
...
public class ParameterSweepUtil {
	...
	public static ParameterSweep createSweep(String param, int value) {
		return new SingleValueSweep<Integer>(param, value);
	}
	...
	public static ParameterSweep createSweep(String param, double value) {
		return new SingleValueSweep<Double>(param, value);
	}
	...
	public static ParameterSweep createSweep(String param, String value) {
		return new SingleValueSweep<String>(param, value);
	}
	 ...
	 * @param values
	 *            the given values for the parameter
	...
	public static <T> ParameterSweep createSweep(String param, List<T> values) {
		return new ListSweep<T>(param, values);
	}
	 ...
	 * @param step
	 *            the value used to build the sequence.
	 * @return a {@link SequenceSweep sequence parameter sweep} that generates a
	 *         sequence of values in a lazy way according to the given
	 *         parameters.
	 */
	...
	/**
	 * <p>
	 * Creates a {@link CombinedParameterSweep} which can be used to combine
	 * multiple {@link ParameterSweep} objects into one structure which also
	 * implements {@link Iterable} of {@link Configuration} objects.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * The order of the generated configurations also depende on the order of
	 * the parameter sweeps passed down in the list.
	 * </p>
	 * <p>
	 * Example:<br>
	 * <br>
	 * for two parameters <b>p1 = {0,1} and p2 = {2,3}</b>, the combined
	 * parameter sweep will provide an iterator that generates the
	 * configurations:<br>
	 * <br>
	 * c1 = {p1=0, p2=2}<br>
	 * c2 = {p1=0, p2=3}<br>
	 ...
	 * of times equals to the given runs value.<br>
	 * <br>
	 * 
	 ...
	 * 
	 * @param sweeps
	 *            the parameter sweeps used to construct this
	 *            {@link CombinedParameterSweep}
	 * @param runs
	 *            the number of runs for each possible parameter configuration
	 * @return a {@link CombinedParameterSweep} which is basically an
	 *         {@link Iterable} structure with all the possible
	 *         {@link Configuration configurations} given the supplied parameter
	 *         sweeps.
	 */
	public static CombinedParameterSweep createCombiedSweep(
			List<ParameterSweep> sweeps, int runs) {
		return new CombinedParameterSweep(sweeps, runs);
	}
