...
public class ParameterSweepUtil {
	...
	/**
	 * Creates a {@link ParameterSweep} object with a given name and Boolean
	 * value.
	 * 
	 * @param param
	 *            the parameter name.
	 ...
	 * @return a {@link SingleValueSweep single value sweep} with a Boolean
	 *         value
	 */
	public static ParameterSweep createSweep(String param, boolean value) {
		return new SingleValueSweep<>(param, value);
	}
