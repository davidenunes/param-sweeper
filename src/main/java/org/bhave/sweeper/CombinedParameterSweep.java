...
public interface CombinedParameterSweep extends Iterable<Configuration> {
    ...
    public static final String CFG_ID_PARAM = "cfg.id";
    ...
    /**
     * Returns all the {@link ParameterSweep} objects used to create this
     * combined sweep
     *
     * @return a list of {@link ParameterSweep}
     */
    List<ParameterSweep> getParameterSweeps();

    File writeSweepFile(String filename) throws IOException;
}
